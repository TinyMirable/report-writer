...
- `tmp/course-report-work/images/drawio/`
...
3. 检查 UML 图是否符合对应 UML 记法，drawio 系统架构图是否符合系统架构图例和绘制准则，D2 图是否符合数据流图、流程图或其他对应表达要求。
...
- drawio 系统架构图不合格: 退回主代理或负责 drawio 的绘图步骤，并说明布局、例图符合度或表达问题。
